...
}', '{include(plugins/swiper/css/swiper.min.css)}', '{include(plugins/swiper/js/swiper.min.js)}');
...
INSERT INTO map_configs.layers(layer_id,title,type,visible,style_config,source,queryable,opacity,abstract,show_meta,origin) VALUES ('kommunmask#1','Origo-mask','GEOJSON',true,'[ [ { "stroke": { "color": "rgba(1,1,1,1.0)" }, "fill": { "color": "rgba(0,0,0,1.0)" } } ] ]','origo-mask.json',false,0.25,'Ett lager som tonar ner de delar av kartan som inte utgör en del av en Origokommun.',true,'origo');
...
CREATE TABLE map_configs.exttools
(
...
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('exttool:exttool_id','<b>Externt verktyg > Id</b><br>Ett unikt id för det externa verktyget.');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('exttool:url','<b>Externt verktyg > Url</b><br>Webbadressen som öppnas när man klickar på knappen för att öppna verktyget.');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('exttool:abstract','<b>Externt verktyg > Beskrivning</b><br>En kort beskrivning av det externa verktyget.');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('exttool:info','<b>Externt verktyg > Info</b><br>Fält för administrativ information om det externa verktyget.');

INSERT INTO map_configs.helps(help_id,abstract) VALUES ('classe:classe_id','<b>Klass > Id</b><br>Ett unikt id för klassen.');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('classe:infogroups','<b>Klass > Informationsgrupper</b><br>En kommaseparerad lista med informationsgrupper som hör till klassen.');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('classe:layers','<b>Klass > Lager</b><br>En kommaseparerad lista med lager som klassen ger åtkomst till.');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('classe:tables','<b>Klass > Tabeller</b><br>En kommaseparerad lista med tabeller som klassen ger åtkomst till.');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('classe:abstract','<b>Klass > Beskrivning</b><br>En informativ beskrivning av klassen.');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('classe:info','<b>Klass > Info</b><br>Fält för administrativ information om klassen.');

INSERT INTO map_configs.helps(help_id,abstract) VALUES ('infogroup:infogroup_id','<b>Informationsgrupp > Id</b><br>Ett unikt id för informationsgruppen.');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('infogroup:infogroups','<b>Informationsgrupp > Informationsgrupper</b><br>En kommaseparerad lista med underordnade informationsgrupper.');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('infogroup:layers','<b>Informationsgrupp > Lager</b><br>En kommaseparerad lista med lager som informationsgruppen ger åtkomst till.');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('infogroup:tables','<b>Informationsgrupp > Tabeller</b><br>En kommaseparerad lista med tabeller som informationsgruppen ger åtkomst till.');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('infogroup:abstract','<b>Informationsgrupp > Beskrivning</b><br>En informativ beskrivning av informationsgruppen.');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('infogroup:info','<b>Informationsgrupp > Info</b><br>Fält för administrativ information om informationsgruppen.');
...
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('service:type','<b>Tjänst > Typ</b><br>Välj typ av tjänst (tänk Qgis Server/Geoserver, inte WMS/WFS) och klicka på knappen "Uppdatera" för att administrationsgränssnittet ska visa rätt inställningsfält. Välj "File" om data läses direkt från fil, t ex GeoJSON.');
...
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('mapstate:abstract','<b>Mapstate > Beskrivning</b><br>En informativ text för administratörer som beskriver mapstatet.');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('mapstate:created','<b>Mapstate > Skapad</b><br>Tidpunkten då någon klickade på "Dela karta" och mapstatet skapades.');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('mapstate:info','<b>Mapstate > Info</b><br>Fält för administrativ information, rörande mapstatet, som inte passar in någon annanstans.');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('mapstate:lastuse','<b>Mapstate > Senast använd</b><br>Tidpunkten då mapstatet senast laddades i en karta.');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('mapstate:mapurl','<b>Mapstate > Kart-url</b><br>Adressen till kartan varifrån man gjorde "Dela karta".');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('mapstate:preserve','<b>Mapstate > Rensas ej</b><br>Mapstates som har "Rensas ej" satt till "t" kommer inte att raderas automatiskt även om det aldrig skulle användas.');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('mapstate:state','<b>Mapstate > Mapstate</b><br>JSON-sträng som innehåller allt som ingår i mapstatet.');
