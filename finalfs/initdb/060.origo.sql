...
INSERT INTO map_configs.plugins(plugin_id,abstract,onload,css,js_files) VALUES ('swiper#1', 'Kristianstads fork av Swiper-plugin från Sigtuna https://github.com/Kristianstad/swiper-plugin.',
'const hideallmodules = getUrlParam(''hideallmodules'');
