...
(
    ...
    info character varying COLLATE pg_catalog."default",
    format character varying COLLATE pg_catalog."default" DEFAULT 'image/png;mode=8bit'::character varying,
    ...
    geometryname character varying COLLATE pg_catalog."default" DEFAULT 'geometry'::character varying,
