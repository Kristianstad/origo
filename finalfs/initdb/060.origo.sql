...
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('map:abstract','<b>Karta > Beskrivning</b><br>En frivillig, informativ text för administratörer som beskriver kartan och dess innehåll.');
...
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('map:keywords','<b>Karta > Nyckelord</b><br>Frivilligt, informativt fält för administratörer som innehåller en kommaseparerad lista av nyckelord som är associerade med kartan. Om man har ett mycket stort antal kartor kan man låta gruppera dessa efter nyckelord genom att lägga till ''maps'' till filen constants/keywordCategorized.php.');
...
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('layer:source','<b>Lager > Källa</b><br>Välj lagrets fördefinierade källa, alternativt lämna fältet tomt om lagret är av typen "GROUP" (ett lager samansatt av andra fördefinierade lager).');
...
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('layer:show_icon','<b>Lager > Visa ikon</b><br>Om "Visa ikon" är satt till "f" kommer en generisk, grå listikon att visas bredvid lagernamnet i lagerträdet. Annars kommer ikonen sättas utifrån "ikon"-fältet, alternativt autogenereras.');
...
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('source:with_geometry','<b>Källa > With_geometry</b><br>Om "With_geometry" är satt till "t" så kommer with_geometry=true att läggas till som parameter i anropen till kartservern.');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('source:fi_point_tolerance','<b>Källa > Fi_point_tolerance</b><br>Om "Fi_point_tolerance" är satt så kommer fi_point_tolerance=värde att läggas till som parameter i anropen till kartservern. "Fi_point_tolerance" skall anges som ett heltal.');
