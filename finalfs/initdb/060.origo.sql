...
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('layer:source','<b>Lager > Källa</b><br>Välj lagrets fördefinierade källa och klicka på knappen "Uppdatera" för att administrationsgränssnittet ska visa rätt inställningsfält.');
