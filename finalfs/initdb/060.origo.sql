...
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('map:palette','<b>Karta > Färgpalett</b><br>JSON-formaterat fält som definierar valbara färger i kartans ritverktyg etc.<br><a href="https://origo-map.github.io/origo-documentation/latest/#palette" target="_blank">Se palett-konfiguration</a>');
