...
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('map:css_files','<b>Karta > CSS-filer</b><br>En kommaseparerad lista med CSS-stilfiler som ska laddas av kartan. Filer som anges med en relativ sökväg (t ex. css/style.css) kommer länkas in i kartans html-fil. Filer som anges med en absolut sökväg (t ex. http://kartor.kristianstad.se/origo/kristianstadskartan/css/style.css) kommer kopieras in i sin helhet i kartans html-fil.');
