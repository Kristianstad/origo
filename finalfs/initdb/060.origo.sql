...
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('map:url','<b>Karta > Url</b><br>Frivilligt, informativt fält där man kan ange en webblänk till kartan. Information för administratörer.');
...
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('map:embedded','<b>Karta > Inbäddad</b><br>Flera av Origos kartkontroller har möjlighet att ändra utseende om kartan bäddas in i en annan webbsida. Om "Inbäddad" är satt till "t" kommer kartan alltid visas som om den var inbäddad, även när så inte är fallet.');
