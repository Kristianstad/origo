...
INSERT INTO map_configs.maps(map_id,title,footer,layers,groups,abstract,show_meta) VALUES ('origo-cities#1','Demokarta - Origo','origo#1','{origo-cities#1}','{none#1,background#1}','En demokarta som visar kommuner delaktiga i Origoprojektet.',true);
...
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('layer:type','<b>Lager > Typ</b><br>Välj det format som ska läsas från källan och klicka sedan på knappen "Uppdatera" för att administrationsgränssnittet ska uppdateras med rätt inställningsfält.<br>Se "type" under aktuellt format i <a href="https://origo-map.github.io/origo-documentation/latest/#layers-1" target="_blank">Origo-dokumentationen</a>');
