...
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('map:url','<b>Karta > Url</b><br>Frivilligt, informativt fält för administratörer där man kan ange en webblänk till kartan.');
...
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('layer:source','<b>Lager > Källa</b><br>Välj lagrets fördefinierade källa, alternativt skriv in ett filnamn med sökväg (om källan är t ex. en json-fil).');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('layer:type','<b>Lager > Typ</b><br>Välj det format som ska läsas från källan och klicka på knappen "Uppdatera" för att administrationsgränssnittet ska uppdateras med rätt inställningsfält.<br>Se "type" under aktuellt format i <a href="https://origo-map.github.io/origo-documentation/latest/#layers-1" target="_blank">Origo-dokumentationen</a>');
...
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('group:show_meta','<b>Grupp > Visa metadata</b><br>Om "Visa metadata" är satt till "t", för gruppen och för kartan, så kommer relevant metadata, som lagts in konfigurationsverktyget, att skrivas in i Origo-konfigurationen när administratören klickar på knappen "Skriv kartkonfiguration". Metadata för gruppens lager blir då synlig i kartans lagerträd.');
