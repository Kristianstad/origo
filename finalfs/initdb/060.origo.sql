...
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('layer:indexweight','<html lang="sv-SE"><head><style>table{line-height:1;float:left}td{min-width:3em;text-align:left;vertical-align:top}.p-indent{padding-left:2em}</style></head><body>Indexvikt kan sättas på lager och anges som ett positivt eller negativt heltalsvärde. Värdet påverkar ritordningen och ibland lagerträdet.<table cellspacing="0" cellpadding="0"><tbody><tr><td colspan="3"><h3>Inga indexvikter satta</h3></td><td></td><td colspan="3"><h3>Lager3=1 <em>eller</em> Lager2=-1</h3></td><td></td><td colspan="3"><h3>Lager4=2</h3></td><td></td><td colspan="3"><h3>Lager3=2 <em>och</em> Lager4=2</h3></td></tr><tr><td><strong>Lagerträd</strong></td><td></td><td><strong>Ritordning</strong></td><td></td><td><strong>Lagerträd</strong></td><td></td><td><strong>Ritordning</strong></td><td></td><td><strong>Lagerträd</strong></td><td></td><td><strong>Ritordning</strong></td><td></td><td><strong>Lagerträd</strong></td><td></td><td><strong>Ritordning</strong></td></tr><tr><td><p>Grupp1</p><p class="p-indent">Lager1</p><p class="p-indent">Lager2</p><p>Grupp2</p><p class="p-indent">Lager3</p><p class="p-indent">Lager4</p></td><td></td><td><p>Lager1</p><p>Lager2</p><p>Lager3</p><p>Lager4</p><p></p></td><td></td><td><p>Grupp1</p><p class="p-indent">Lager1</p><p class="p-indent">Lager2</p><p>Grupp2</p><p class="p-indent">Lager3</p><p class="p-indent">Lager4</p></td><td></td><td><p>Lager1</p><p><strong><em>Lager3</em></strong></p><p><strong><em>Lager2</em></strong></p><p>Lager4</p></td><td></td><td><p>Grupp1</p><p class="p-indent">Lager1</p><p class="p-indent">Lager2</p><p>Grupp2</p><p class="p-indent"><strong><em>Lager4</em></strong></p><p class="p-indent"><strong><em>Lager3</em></strong></p></td><td></td><td><p>Lager1</p><p><strong><em>Lager4</em></strong></p><p><strong><em>Lager2</em></strong></p><p><strong><em>Lager3</em></strong></p></td><td></td><td><p>Grupp1</p><p class="p-indent">Lager1</p><p class="p-indent">Lager2</p><p>Grupp2</p><p class="p-indent">Lager3</p><p class="p-indent">Lager4</p></td><td></td><td><p><em><strong>Lager3</strong></em></p><p><em><strong>Lager4</strong></em></p><p><em><strong>Lager1</strong></em></p><p><em><strong>Lager2</strong></em></p></td></tr></tbody></table></body></html>');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('layer:layer_id','<b>Lager-id</b><br>Ett unikt id som används som primärnyckel i databasen. Text framför #-tecknet utgör name i json-konfigurationen.<br><a href="https://origo-map.github.io/origo-documentation/latest/#layers-1" target="_blank">Se lagerkonfiguration</a>');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('group:group_id','<b>Grupp-id</b><br>Ett unikt id som används som primärnyckel i databasen. Text framför #-tecknet utgör name i json-konfigurationen.<br><a href="https://origo-map.github.io/origo-documentation/latest/#groups" target="_blank">Se gruppkonfiguration</a>');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('map:map_id','<b>Kart-id</b><br>Ett unikt id som används som primärnyckel i databasen.<br><a href="https://origo-map.github.io/origo-documentation/latest/#basic-settings" target="_blank">Se grundkonfiguration</a>');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('control:control_id','<b>Kontroll-id</b><br>Ett unikt id som används som primärnyckel i databasen. Text framför #-tecknet utgör name i json-konfigurationen.<br><a href="https://origo-map.github.io/origo-documentation/latest/#controls-1" target="_blank">Se kontrollkonfiguration</a>');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('source:source_id','<b>Käll-id</b><br>Ett unikt id som används som primärnyckel i databasen samt för identifiering i json-konfigurationen.<br><a href="https://origo-map.github.io/origo-documentation/latest/#source" target="_blank">Se källkonfiguration</a>');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('service:service_id','<b>Tjänst-id</b><br>Ett unikt id som används som primärnyckel i databasen.<br><a href="https://origo-map.github.io/origo-documentation/latest/#source" target="_blank">Se källkonfiguration</a>');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('tilegrid:tilegrid_id','<b>Tilegrid-id</b><br>Ett unikt id som används som primärnyckel i databasen.<br><a href="https://origo-map.github.io/origo-documentation/latest/#source" target="_blank">Se källkonfiguration</a><br><a href="https://origo-map.github.io/origo-documentation/latest/#tilegridoptions" target="_blank">Se tilegrid-konfiguration</a>');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('footer:footer_id','<b>Sidfots-id</b><br>Ett unikt id som används som primärnyckel i databasen.<br><a href="https://origo-map.github.io/origo-documentation/latest/#footer" target="_blank">Se sidfotskonfiguration</a>');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('proj4def:code','<b>EPSG-kod</b><br>Ett unikt id som används som primärnyckel i databasen samt utgör code i json-konfigurationen.<br><a href="https://origo-map.github.io/origo-documentation/latest/#proj4defs" target="_blank">Se proj4def-konfiguration</a>');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('layer:attributes','<b>Attribut</b><br>JSON-formaterat fält som anger vilka attribut som ska visas för valt lager.<br><a href="https://origo-map.github.io/origo-documentation/latest/#attributes" target="_blank">Se attributkonfiguration</a>');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('layer:style_config','<b>Stilkonfiguration</b><br>Manuell stilkonfiguration (JSON) som huvudsakligen används för vektorlager. Om fältet används för andra typer av lager, så som WMS-lager, inaktiveras den förenklade stilsättningen som använder fälten "Stilfilter", "Ikon", "Utfälld ikon" m fl.<br><a href="https://origo-map.github.io/origo-documentation/latest/#style-basics" target="_blank">Se stilkonfiguration</a>');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('layer:style_layer','<b>Stillager</b><br>Kan sättas till ett lager-id varifrån stilsättningen hämtas. Inaktiverar annan stilsättning som satts i fälten "Stilkonfiguration", "Stilfilter", "Ikon", "Utfälld ikon" m fl.');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('layer:style_filter','<b>Stilfilter</b><br>Kan innehålla ett sträng som filtererar lagret efter attributvärden. Har ingen effekt om något av fälten "Stillager" eller "Stilkonfiguration" är satta.<br>Exempel (visa företeelser där attributet "signatur" har värdet MW eller MD): <i>[signatur] == ''MW'' OR [signatur] == ''MD''</i><br><a href="https://origo-map.github.io/origo-documentation/latest/#filter" target="_blank">Se filterkonfiguration</a>');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('map:url','<b>Url</b><br>Frivilligt, informativt fält där man kan ange en webblänk till kartan.');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('map:layers','<b>Lager</b><br>En kommaseparerad lista med lager-idn för de lager som ska ligga i roten av kartan (utan att ligga i någon undergrupp). Ordningen i listan bestämmer ordningen i lagerträdet.');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('map:groups','<b>Grupper</b><br>En kommaseparerad lista med grupp-idn för de grupper som ska ligga i roten av kartan. Ordningen i listan bestämmer ordningen i lagerträdet.');
