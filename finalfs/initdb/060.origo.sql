...
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('source:softversion','<b>Källa > Programversion</b><br>Ett frivilligt, informativt fält där man kan ange relevant versionsnummer för bakomliggande data- eller projektfil. Fältet måste ajourhållas manuellt. För Qgis Server-källor får man alltid upp korrekt version när man klickar på "Info"-knappen.');
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('source:updated','<b>Källa > Uppdaterad (åååå-mm-dd)</b><br>Ett frivilligt, informativt fält där man kan ange när källan senast uppdaterades. Fältet måste ajourhållas manuellt. För Qgis Server-källor får man alltid upp korrekt uppdaterad-information när man klickar på "Info"-knappen.');
