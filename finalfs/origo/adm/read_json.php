...
if ($_POST['layers'] == 'yes')
{
	...
	foreach ($allLayers as $layer)
	{
		...
		{
			$layer['abstract']=preg_replace("|<form action='[^']*' method='post' target='_blank'><button type='submit' name='layerId' value='[^']*' style='[^']*'>Administrera</button></form>|i", '', $layer['abstract']);
		}
