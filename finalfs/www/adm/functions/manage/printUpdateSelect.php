<?php
	...
	// Takes a full target array, parameter values (array), style class (string), label (string), help-exist (boolean), select options (optional, array, needs to have equal number of elements as parameter two).
